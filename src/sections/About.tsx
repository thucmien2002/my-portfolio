export default function About() {
    return (
        <section id="about" className="py-24 px-6 bg-white text-slate-900 dark:bg-slate-950 dark:text-white scroll-mt-24 transition-colors">
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="grid grid-cols-2 gap-4">
                    {[
                        ...
                        <div
                            key={index}
                            className="p-4 border border-slate-200 dark:border-white/10 rounded-xl bg-slate-100 dark:bg-white/5 text-center hover:bg-slate-200 dark:hover:bg-white/10 transition"
                        >
                            {skill}
                        </div>
                    ))}
